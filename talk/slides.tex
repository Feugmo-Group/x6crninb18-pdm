...
%% Figures live in the manuscript folder; the deck reads them rather than
%% keeping a second copy that could go stale.
...
\title{Sparse data limit what a corrosion model can predict}
